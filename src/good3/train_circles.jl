...
model = Chain(Dense(2, hidden_dim, relu6, init=Flux.kaiming_uniform),
              Dense(hidden_dim, hidden_dim, relu6, init=Flux.kaiming_uniform),
              Dense(hidden_dim, hidden_dim * 2, relu6, init=Flux.kaiming_uniform),
